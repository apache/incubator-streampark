...
import org.apache.flink.table.api.bridge.scala.internal.{OverrideStreamTableEnvironmentImpl, StreamTableEnvironmentImpl}
 ...
 */
@PublicEvolving
trait OverrideStreamTableEnvironment extends TableEnvironment {
...
object OverrideStreamTableEnvironment {
   ...
   *                             [[TableEnvironment]].
   */
  def create(executionEnvironment: StreamExecutionEnvironment): OverrideStreamTableEnvironment = {
    create(
  ...
  : OverrideStreamTableEnvironmentImpl = {
    OverrideStreamTableEnvironmentImpl.create(executionEnvironment, settings, new TableConfig)
  }
   ...
   *             [[OverrideStreamTableEnvironment#getConfig()]] for manipulating the [[TableConfig]].
   */
  @deprecated
