...
import org.apache.flink.table.api.internal.{OverrideTableEnvironmentImpl, TableEnvironmentImpl}
...
/**
 * The implementation for a Scala [[OverrideStreamTableEnvironment]]. This enables conversions from/to
 * [[DataStream]]. It is bound to a given [[StreamExecutionEnvironment]].
 */
@Internal
class OverrideStreamTableEnvironmentImpl(
  ...
  extends OverrideTableEnvironmentImpl(
    catalogManager,
    moduleManager,
    config,
    executor,
    ...
    isStreaming,
    userClassLoader)
    with OverrideStreamTableEnvironment {
...
object OverrideStreamTableEnvironmentImpl {

  def create(
              executionEnvironment: StreamExecutionEnvironment,
              settings: EnvironmentSettings,
              tableConfig: TableConfig)
  : OverrideStreamTableEnvironmentImpl = {

    if (!settings.isStreamingMode) {
      throw new TableException(
        "OverrideStreamTableEnvironment can not run in batch mode for now, please use TableEnvironment.")
    }
    ...
    new OverrideStreamTableEnvironmentImpl(
      catalogManager,
      moduleManager,
      functionCatalog,
      tableConfig,
  ...
  private def lookupExecutor(executorProperties: JMap[String, String],
