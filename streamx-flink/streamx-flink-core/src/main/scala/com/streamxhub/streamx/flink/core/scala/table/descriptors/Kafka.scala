 ...
 * under the License.
 */
package com.streamxhub.streamx.flink.core.scala.table.descriptors

import com.streamxhub.streamx.common.conf.ConfigConst.{KAFKA_SOURCE_PREFIX, KEY_KAFKA_TOPIC}
import com.streamxhub.streamx.common.util.ConfigUtils
import com.streamxhub.streamx.flink.core.scala.table.descriptors.KafkaVer.KafkaVer
