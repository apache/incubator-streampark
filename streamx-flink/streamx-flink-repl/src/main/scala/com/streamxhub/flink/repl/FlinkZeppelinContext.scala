...
import com.streamxhub.flink.repl.sql._
...
class FlinkZeppelinContext(val flinkInterpreter: FlinkScalaInterpreter,
  ...
  private val interpreterClassMap = Map(
    "flink" -> "com.streamxhub.flink.repl.FlinkInterpreter",
    "bsql" -> "com.streamxhub.flink.repl.FlinkBatchSqlInterpreter",
    "ssql" -> "com.streamxhub.flink.repl.FlinkStreamSqlInterpreter",
    "pyflink" -> "com.streamxhub.flink.repl.PyFlinkInterpreter",
    "ipyflink" -> "com.streamxhub.flink.repl.IPyFlinkInterpreter"
  )
