...
import com.streamxhub.streamx.flink.connector.http.scala.conf.HttpConfigConst.HTTP_SINK_PREFIX
import com.streamxhub.streamx.flink.connector.http.scala.internal.HttpSinkFunction
