...
package com.streamxhub.streamx.flink.connector.kafka.java.source;

import com.streamxhub.streamx.flink.core.scala.StreamingContext;
import com.streamxhub.streamx.flink.connector.kafka.scala.source.KafkaRecord;
import com.streamxhub.streamx.flink.connector.kafka.scala.source.KafkaStringDeserializationSchema;
...
public class KafkaSource<T> {
    ...
    public DataStreamSource<KafkaRecord<T>> getDataStream() {
        FlinkKafkaConsumer<KafkaRecord<T>> consumer = com.streamxhub.streamx.flink.connector.kafka.scala.source.KafkaSource.getSource(
            this.context,
            this.property,
            this.topics,
            this.alias,
