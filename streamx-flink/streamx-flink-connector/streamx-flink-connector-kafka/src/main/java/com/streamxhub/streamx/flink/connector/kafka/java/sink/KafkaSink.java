...
package com.streamxhub.streamx.flink.connector.kafka.java.sink;

import com.streamxhub.streamx.flink.core.scala.StreamingContext;
import com.streamxhub.streamx.flink.connector.kafka.scala.sink.KafkaEqualityPartitioner;
...
public class KafkaSink<T> {
    ...
    public DataStreamSink<T> sink(DataStream<T> source, String topic) {
        this.topic(topic);
        com.streamxhub.streamx.flink.connector.kafka.scala.sink.KafkaSink scalaSink = new com.streamxhub.streamx.flink.connector.kafka.scala.sink.KafkaSink(
            this.context,
            this.property,
            this.parallelism,
            this.name,
