...
import com.streamxhub.streamx.flink.connector.scala.source.KafkaRecord;
import com.streamxhub.streamx.flink.connector.scala.source.KafkaStringDeserializationSchema;
...
public class KafkaSource<T> {
    ...
    public DataStreamSource<KafkaRecord<T>> getDataStream() {
        FlinkKafkaConsumer<KafkaRecord<T>> consumer = com.streamxhub.streamx.flink.connector.scala.source.KafkaSource.getSource(
            this.context,
            this.property,
            this.topics,
            this.alias,
