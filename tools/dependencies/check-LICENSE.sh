...
# contributor license agreements.  See the NOTICE file dist-license-checkributed with
...
# dist-license-checkributed under the License is dist-license-checkributed on an "AS IS" BASIS,
