...
package com.streamxhub.plugin.profiling.examples;
...
public class HelloWorldApplication {
     ...
     * -javaagent:target/uber-java-agent-0.0.1-jar-with-dependencies.jar=reporter=com.streamxhub.plugin.profiling.reporters.ConsoleOutputReporter,tag=tag1,metricInterval=10000,durationProfiling=com.streamxhub.plugin.profiling.examples.HelloWorldApplication.*
     */
