 ...
 * <p>
 * reporter=com.streamxhub.plugin.profiling.reporters.GraphiteOutputReporter
 * <p>
 * To use properties from yaml file use below command.
 * <p>
 * reporter=com.streamxhub.plugin.profiling.reporters.GraphiteOutputReporter,configProvider=com.streamxhub.plugin.profiling
...
public class GraphiteOutputReporter implements Reporter {
    ...
    @Override
    public void doArguments(Map<String, List<String>> connectionProperties) {
