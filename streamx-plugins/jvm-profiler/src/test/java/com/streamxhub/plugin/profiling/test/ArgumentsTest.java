...
public class ArgumentsTest {
    ...
    public void allArguments() {
        Arguments arguments = Arguments.parseArgs("reporter=com.streamxhub.plugin.profiling.ArgumentsTest$DummyReporter,durationProfiling=a.bc.foo,metricInterval=123,appIdVariable=APP_ID1,appIdRegex=app123,argumentProfiling=package1.class1.method1.1");
    ...
    public void setConfigProvider() {
        ...
        arguments.setConfigProvider("com.streamxhub.plugin.profiling.ArgumentsTest$DummyConfigProvider");
