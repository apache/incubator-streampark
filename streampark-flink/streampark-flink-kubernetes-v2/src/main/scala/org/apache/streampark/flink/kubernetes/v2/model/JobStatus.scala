...
import org.apache.streampark.shaded.org.apache.flink.kubernetes.operator.api.status.{JobStatus => FlinkJobStatus}

import scala.util.Try

/**
 * Flink Job Status received from Flink REST API.
 *
 * @param jobId  Job id
 ...
 * see: [[org.apache.streampark.shaded.org.apache.flink.kubernetes.operator.api.status.JobStatus]]
 */
