...
/** Flink 1.12 stream-table environment context. */
public class StreamTableContext extends FlinkStreamTableTrait {
    ...
    public StreamTableDescriptor connect(ConnectorDescriptor connectorDescriptor) {
        return getStreamTableEnv().connect(connectorDescriptor);
    }

    public StreamGraph $getStreamGraph(String jobName) {
        return getStreamEnv().getStreamGraph(jobName);
    }

    public StreamGraph $getStreamGraph(String jobName, boolean clearTransformations) {
        return getStreamEnv().getStreamGraph(jobName, clearTransformations);
    }
