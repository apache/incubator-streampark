...
import org.apache.flink.kubernetes.kubeclient.resources.KubernetesService.ServiceType;

import java.util.Optional;

/** Flink 1.15 Kubernetes client. */
public class FlinkKubernetesClient extends FlinkKubernetesClientTrait {
    ...
    public Optional<KubernetesService> getService(String serviceName) {
        return kubeClient.getService(ServiceType.REST_SERVICE, serviceName);
    }
}
