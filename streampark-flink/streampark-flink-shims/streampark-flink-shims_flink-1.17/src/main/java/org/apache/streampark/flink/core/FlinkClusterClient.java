...
public class FlinkClusterClient<T> extends FlinkClientTrait<T> {
    ...
    @Override
    public CompletableFuture<String> stopWithSavepoint(JobID jobID, boolean advanceToEndOfEventTime, String savepointDir) {
        return clusterClient().stopWithSavepoint(jobID, advanceToEndOfEventTime, savepointDir, SavepointFormatType.DEFAULT);
    }
}
