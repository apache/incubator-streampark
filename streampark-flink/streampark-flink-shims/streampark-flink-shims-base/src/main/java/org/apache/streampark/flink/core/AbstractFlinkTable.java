...
/** Base table environment adapter with SQL execution helpers. */
public abstract class AbstractFlinkTable implements TableEnvironment {

    public final FlinkJobParameters parameter;

    private final TableEnvironment tableEnv;

    protected AbstractFlinkTable(FlinkJobParameters parameter, TableEnvironment tableEnv) {
    ...
    public void sql() {
        FlinkSqlExecutor.executeSql(parameter, this);
    }

    /** Executes SQL configured by the supplied parameter key. */
    public void sql(String sqlKey) {
        FlinkSqlExecutor.executeSql(sqlKey, parameter, this);
    }
    ...
    public TableResult executePlan(PlanReference planReference) throws TableException {
        return tableEnv.executePlan(planReference);
    }
    ...
    @Override
    public void useCatalog(@Nullable String catalogName) {
    ...
    @Override
    public void useDatabase(@Nullable String databaseName) {
    ...
    @Override
    public CompiledPlan compilePlanSql(String stmt) throws TableException {
