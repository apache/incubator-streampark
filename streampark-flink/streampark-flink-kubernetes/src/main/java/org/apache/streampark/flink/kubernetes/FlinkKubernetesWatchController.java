...
public class FlinkKubernetesWatchController extends LoggerSupport implements AutoCloseable {
    ...
    public final KubernetesDeploymentEventCache k8sDeploymentEvents = KubernetesDeploymentEventCache.build();
    public final MetricCache flinkMetrics = MetricCache.build();

    public FlinkKubernetesWatchController(JobStatusWatcherConfig conf) {
