...
import org.apache.streampark.flink.kubernetes.watcher.FlinkKubernetesEventWatcher;
...
public class DefaultFlinkKubernetesWatcher extends LoggerSupport implements FlinkKubernetesWatcher {

    public final FlinkKubernetesWatchController watchController;

    private final ChangeEventBus eventBus;
    private final FlinkKubernetesEventWatcher k8sEventWatcher;
    ...
    public DefaultFlinkKubernetesWatcher(FlinkTrackConfig conf) {
        this.watchController = new FlinkKubernetesWatchController(conf.jobStatusWatcherConf());
        this.eventBus = new ChangeEventBus();
        this.eventBus.registerListener(new BuildInEventListener());
        this.k8sEventWatcher = new FlinkKubernetesEventWatcher(watchController);
