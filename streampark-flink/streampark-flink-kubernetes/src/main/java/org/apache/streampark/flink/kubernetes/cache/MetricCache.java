...
public class MetricCache {
  ...
  public void put(ClusterKey clusterKey, FlinkMetricCV flinkMetricCV) {
    cache.put(clusterKey, flinkMetricCV);
  }
  ...
  public Map<ClusterKey, FlinkMetricCV> getAll(Set<ClusterKey> clusterKeySet) {
    return cache.getAllPresent(clusterKeySet);
  }

  public FlinkMetricCV get(ClusterKey clusterKey) {
