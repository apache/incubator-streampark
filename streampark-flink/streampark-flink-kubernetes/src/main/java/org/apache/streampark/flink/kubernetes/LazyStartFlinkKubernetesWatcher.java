 ...
 */
public class LazyStartFlinkKubernetesWatcher implements FlinkKubernetesWatcher {

    private final DefaultFlinkKubernetesWatcher delegate;

    public LazyStartFlinkKubernetesWatcher(DefaultFlinkKubernetesWatcher delegate) {
