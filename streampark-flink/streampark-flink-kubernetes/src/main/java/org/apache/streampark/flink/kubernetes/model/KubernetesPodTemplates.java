...
@Builder
@AllArgsConstructor
public class KubernetesPodTemplates {
    ...
    public static KubernetesPodTemplates empty() {
        return KubernetesPodTemplates.builder().build();
    }

    public static KubernetesPodTemplates of(String podTemplate, String jmPodTemplate, String tmPodTemplate) {
        return KubernetesPodTemplates.builder()
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof KubernetesPodTemplates)) {
            return false;
        }
        KubernetesPodTemplates that = (KubernetesPodTemplates) obj;
