...
public enum FlinkKubernetesDeployMode {
    ...
    FlinkKubernetesDeployMode(String value) {
        this.value = value;
    }

    @JsonCreator
    public static FlinkKubernetesDeployMode of(String value) {
        for (FlinkKubernetesDeployMode mode : FlinkKubernetesDeployMode.values()) {
    ...
    public static FlinkKubernetesDeployMode of(FlinkDeployMode mode) {
        switch (mode) {
    ...
    public static FlinkDeployMode toFlinkDeployMode(FlinkKubernetesDeployMode mode) {
        switch (mode) {
            case SESSION:
