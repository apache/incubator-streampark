...
public class DockerPullSnapshot {
    ...
    public static DockerPullSnapshot of(List<DockerLayerProgress> detail, String error, long emitTime) {
        ...
        return new DockerPullSnapshot(detail, error, emitTime, Utils.calPercent(current, total));
    }
}
