...
package org.apache.streampark.flink.client.response;
...
/** Result of submitting a Flink job. */
public final class SubmitResponse implements Serializable {
    ...
    public SubmitResponse(
        ...
        this.flinkConfig =
            Collections.unmodifiableMap(new LinkedHashMap<>(flinkConfig));
