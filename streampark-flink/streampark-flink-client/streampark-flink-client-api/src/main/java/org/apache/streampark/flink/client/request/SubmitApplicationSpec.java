...
public final class SubmitApplicationSpec implements Serializable {
    ...
    private final boolean standardYaml;
    ...
    private SubmitApplicationSpec(Builder builder) {
        ...
        this.standardYaml = builder.standardYaml;
    ...
    /** Returns whether the persisted Flink configuration uses standard nested YAML. */
    ...
    public static final class Builder {
        ...
        /** Records the syntax selected when the Flink configuration content was persisted. */
        public Builder standardYaml(boolean standardYaml) {
