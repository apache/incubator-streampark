...
public class ES6Sink implements Sink {
    ...
    private final ES6Config config;

    public ES6Sink(StreamingContext ctx, Properties property, int parallelism, String name, String uid) {
        this.ctx = ctx;
        ...
        this.config = new ES6Config(prop);
    }

    public static ES6Sink of(StreamingContext ctx, Properties property, int parallelism, String name, String uid) {
        return new ES6Sink(ctx, property, parallelism, name, uid);
    }
