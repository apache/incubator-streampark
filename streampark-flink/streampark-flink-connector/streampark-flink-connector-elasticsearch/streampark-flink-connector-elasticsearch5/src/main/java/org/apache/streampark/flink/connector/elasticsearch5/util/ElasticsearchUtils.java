...
package org.apache.streampark.flink.connector.elasticsearch5.util;
...
public final class ElasticsearchUtils {
    ...
    public static IndexRequest indexRequest(String index, String indexType, String id, String source) {
        return indexRequest(index, indexType, id, source, XContentType.JSON);
    }

    public static IndexRequest indexRequest(String index, String indexType, String id, String source, XContentType xContentType) {
        ...
        IndexRequest indexReq = new IndexRequest(index, indexType, id);
