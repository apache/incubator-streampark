...
public class ES7SinkConfigOption implements Serializable {
    ...
    public ES7SinkConfigOption(String prefixStr, Properties properties) {
    ...
    public static ES7SinkConfigOption of(Properties properties) {
        return new ES7SinkConfigOption(ES_SINK_PREFIX, properties);
    }
