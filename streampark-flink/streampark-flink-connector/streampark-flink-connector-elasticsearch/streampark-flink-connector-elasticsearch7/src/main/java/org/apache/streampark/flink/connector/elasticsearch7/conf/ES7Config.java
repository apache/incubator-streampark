...
public class ES7Config implements Serializable {
    public final ES7SinkConfigOption sinkOption;
    ...
    public ES7Config(Properties parameters) {
        this.sinkOption = ES7SinkConfigOption.of(parameters);
