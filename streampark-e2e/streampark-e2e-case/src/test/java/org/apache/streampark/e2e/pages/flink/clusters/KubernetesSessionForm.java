...
@Getter
public class KubernetesSessionForm extends CommonForm {
    ...
    public KubernetesSessionForm(ClusterDetailForm clusterDetailForm) {
        super(clusterDetailForm);
        this.driver = clusterDetailForm.driver;
    }

    public KubernetesSessionForm resolveOrder(ResolveOrder resolveOrder) {
    ...
    public KubernetesSessionForm flinkImage(String flinkImage) {
        WebElementDeleteAndInput(inputFlinkImage, flinkImage);
        return this;
    }

    public KubernetesSessionForm k8sNamespace(String k8sNamespace) {
