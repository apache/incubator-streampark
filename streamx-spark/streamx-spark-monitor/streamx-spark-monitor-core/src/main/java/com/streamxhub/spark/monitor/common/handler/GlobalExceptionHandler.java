package com.streamxhub.spark.monitor.common.handler;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(value = StreamXException.class)
    @ResponseStatus(HttpStatus.INTERNAL_SERVER_ERROR)
    public RestResponse handleParamsInvalidException(StreamXException e) {
