 ...
 */
case class FlinkJobStatusWatcherConf(sglTrkTaskTimeoutSec: Long,
                                     sglTrkTaskIntervalSec: Long)

object FlinkJobStatusWatcherConf {
  def default: FlinkJobStatusWatcherConf = FlinkJobStatusWatcherConf(sglTrkTaskTimeoutSec = 120, sglTrkTaskIntervalSec = 10)
}
