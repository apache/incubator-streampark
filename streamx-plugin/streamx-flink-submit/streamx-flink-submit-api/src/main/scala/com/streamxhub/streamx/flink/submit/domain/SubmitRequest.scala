...
import com.streamxhub.streamx.common.conf.{FlinkConfigKeyConst, Workspace}
...
case class SubmitRequest(flinkVersion: FlinkVersion,
  ...
  lazy val appMain: String = appProperties(FlinkConfigKeyConst.KEY_APPLICATION_MAIN_CLASS)
