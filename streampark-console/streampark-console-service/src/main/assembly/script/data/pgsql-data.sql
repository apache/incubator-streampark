...
insert into "public"."t_setting" values (16, 'streampark.uploads.record.limit', 25, 'Uploads file record limit', 'Job dependent query limit on the number of uploaded files', 1);
