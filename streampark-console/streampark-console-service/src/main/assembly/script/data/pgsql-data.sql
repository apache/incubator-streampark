...
-- ----------------------------
insert into "public"."t_flink_app" values (100000, 100000, 2, 4, null, null, 'Flink SQL Demo', null, null, null, null, null, null, null , null, 100000, 1, null, null, null, null, null, null, null, 0, 0, null, null, null, null, null, null, 'Flink SQL Demo', 0, null, null, null, null, null, null, null, 0, 0, now(), now(), null, 1, true, null, null, null, null, null, null, false, null, null, null, 'streampark,test');
...
insert into "public"."t_menu" values (130201, 130200, 'alert view', null, null, 'alert:view', null, '1', '1', null, now(), now());
insert into "public"."t_menu" values (130202, 130200, 'alert add', null, null, 'alert:add', null, '1', '1', null, now(), now());
insert into "public"."t_menu" values (130203, 130200, 'alert update', null, null, 'alert:update', null, '1', '1', null, now(), now());
insert into "public"."t_menu" values (130204, 130200, 'alert delete', null, null, 'alert:delete', null, '1', '1', null, now(), now());
insert into "public"."t_menu" values (130301, 130300, 'env create', null, null, 'env:create', null, '1', '1', null, now(), now());
insert into "public"."t_menu" values (130302, 130300, 'env update', null, null, 'env:update', null, '1', '1', null, now(), now());
insert into "public"."t_menu" values (130303, 130300, 'env delete', null, null, 'env:delete', null, '1', '1', null, now(), now());
...
insert into "public"."t_role_menu" (role_id, menu_id) values (100002, 130201);
insert into "public"."t_role_menu" (role_id, menu_id) values (100002, 130202);
insert into "public"."t_role_menu" (role_id, menu_id) values (100002, 130203);
insert into "public"."t_role_menu" (role_id, menu_id) values (100002, 130204);
insert into "public"."t_role_menu" (role_id, menu_id) values (100002, 130301);
insert into "public"."t_role_menu" (role_id, menu_id) values (100002, 130302);
insert into "public"."t_role_menu" (role_id, menu_id) values (100002, 130303);
