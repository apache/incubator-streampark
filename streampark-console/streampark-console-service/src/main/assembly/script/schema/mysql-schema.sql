...
create table `t_flink_cluster` (
  ...
  unique key `un_flink_cluster_id` (`id`) using btree,
...
-- ----------------------------
drop table if exists `t_managed_flink_operation`;
drop table if exists `t_managed_flink_state_event`;
drop table if exists `t_managed_flink_snapshot`;
drop table if exists `t_managed_flink_artifact`;
drop table if exists `t_managed_flink_app`;
drop table if exists `t_managed_flink_env`;
drop table if exists `t_cloud_account_team`;
...
-- ----------------------------
create table `t_cloud_account_team` (
...
-- ----------------------------
create table `t_managed_flink_env` (
...
-- ----------------------------
create table `t_managed_flink_app` (
  `app_id` bigint not null,
...
-- ----------------------------
create table `t_managed_flink_artifact` (
  `id` bigint not null auto_increment,
  `managed_env_id` bigint not null,
...
-- ----------------------------
create table `t_managed_flink_snapshot` (
  `id` bigint not null auto_increment,
  `app_id` bigint not null,
...
-- ----------------------------
create table `t_managed_flink_state_event` (
  `id` bigint not null auto_increment,
  `app_id` bigint not null,
...
-- ----------------------------
create table `t_managed_flink_operation` (
  `id` bigint not null auto_increment,
  `app_id` bigint not null,
