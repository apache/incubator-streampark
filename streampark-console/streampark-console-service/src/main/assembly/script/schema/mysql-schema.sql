...
create table `t_spark_app` (
  ...
  `driver_cores` bigint default 0,
  `driver_memory` bigint default 0,
  `executor_cores` bigint default 0,
  `executor_memory` bigint default 0,
  `executor_max_nums` bigint default 0,
  `num_tasks` bigint default 0,
  `num_completed_tasks` bigint default 0,
  `num_stages` bigint default 0,
  `num_completed_stages` bigint default 0,
  `used_memory` bigint default 0,
  `used_v_cores` bigint default 0,
  primary key (`id`) using btree,
  key `inx_job_type` (`job_type`) using btree,
  key `inx_track` (`tracking`) using btree,
  index `inx_team` (`team_id`) using btree
