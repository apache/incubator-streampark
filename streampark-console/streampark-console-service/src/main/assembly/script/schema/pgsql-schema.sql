...
drop table if exists "public"."t_managed_flink_operation";
drop table if exists "public"."t_managed_flink_state_event";
drop table if exists "public"."t_managed_flink_snapshot";
drop table if exists "public"."t_managed_flink_artifact";
drop table if exists "public"."t_managed_flink_app";
drop table if exists "public"."t_managed_flink_env";
drop table if exists "public"."t_cloud_account_team";
drop table if exists "public"."t_cloud_account";
...
-- ----------------------------
drop sequence if exists "public"."streampark_t_cloud_account_id_seq";
drop sequence if exists "public"."streampark_t_managed_flink_artifact_id_seq";
drop sequence if exists "public"."streampark_t_managed_flink_snapshot_id_seq";
drop sequence if exists "public"."streampark_t_managed_flink_state_event_id_seq";
drop sequence if exists "public"."streampark_t_managed_flink_operation_id_seq";
...
drop sequence if exists "public"."streampark_t_resource_id_seq";
...
create unique index "un_flink_cluster_id" on "public"."t_flink_cluster" using btree ("id");
...
-- ----------------------------
-- table structure for managed Flink
-- ----------------------------
create sequence "public"."streampark_t_cloud_account_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table "public"."t_cloud_account" (
...
create table "public"."t_cloud_account_team" (
...
create index "inx_cloud_account_team_team"
  on "public"."t_cloud_account_team" using btree ("team_id");

create table "public"."t_managed_flink_env" (
  "cluster_id" int8 not null,
  "provider_type" varchar(32) not null,
  "cloud_account_id" int8 not null,
  "region" varchar(64) not null,
  "provider_config_json" text not null,
  "provider_config_version" int4 not null default 1,
...
create index "inx_managed_flink_env_account"
  on "public"."t_managed_flink_env" using btree ("cloud_account_id");

create table "public"."t_managed_flink_app" (
  "app_id" int8 not null,
...
create index "inx_managed_flink_app_env"
  on "public"."t_managed_flink_app" using btree ("managed_env_id");
create index "inx_managed_flink_app_sync"
  on "public"."t_managed_flink_app" using btree ("sync_state", "next_sync_time");

create sequence "public"."streampark_t_managed_flink_artifact_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table "public"."t_managed_flink_artifact" (
  "id" int8 not null
...
create index "inx_managed_flink_artifact_state"
  on "public"."t_managed_flink_artifact"
    using btree ("state", "staging_lease_until");

create sequence "public"."streampark_t_managed_flink_snapshot_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table "public"."t_managed_flink_snapshot" (
  "id" int8 not null
...
create index "inx_managed_flink_snapshot_state"
  on "public"."t_managed_flink_snapshot"
    using btree ("app_id", "state", "trigger_time");

create sequence "public"."streampark_t_managed_flink_state_event_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table "public"."t_managed_flink_state_event" (
  "id" int8 not null
...
create index "inx_managed_flink_state_event_app"
  on "public"."t_managed_flink_state_event" using btree ("app_id", "create_time");
create index "inx_managed_flink_state_event_alert"
  on "public"."t_managed_flink_state_event" using btree ("alert_state", "modify_time");

create sequence "public"."streampark_t_managed_flink_operation_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table "public"."t_managed_flink_operation" (
  "id" int8 not null
...
create index "inx_managed_flink_operation_active"
  on "public"."t_managed_flink_operation" using btree ("app_id", "state");
create index "inx_managed_flink_operation_retry"
...
create trigger "streampark_t_cloud_account_modify_time_tri" before update on "public"."t_cloud_account" for each row execute procedure "public"."update_modify_time"();
