...
public class YarnQueueServiceImpl extends ServiceImpl<YarnQueueMapper, YarnQueue>
  ...
  @Override
  public IPage<YarnQueue> pageYarnQueues(YarnQueue yarnQueue, RestRequest request) {
  ...
  @Override
  public boolean saveYarnQueue(YarnQueue yarnQueue) {
  ...
  @Override
  public void removeYarnQueue(YarnQueue yarnQueue) {
    YarnQueue queueFromDB = getYarnQueueByIdWithPreconditions(yarnQueue);
