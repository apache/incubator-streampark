  ...
  public void start(Application appParam, boolean auto) throws Exception {
    ...
    SubmitRequest submitRequest =
        new SubmitRequest(
            ...
            appParam.getRestoreMode() == null ? null : RestoreModeEnum.of(appParam.getRestoreMode()),
            applicationArgs,
            buildResult,
        ...
        .whenComplete(
            (t, e) -> {
              if (!K8sFlinkConfig.isV2Enabled()
                  && ExecutionModeEnum.isKubernetesApplicationMode(application.getExecutionMode())) {
