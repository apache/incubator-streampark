...
public class FlinkAppHttpWatcher {
  ...
  private final Timeout HTTP_TIMEOUT = Timeout.ofSeconds(5);
  ...
  private void handleRunningState(
      Application application, OptionStateEnum optionState, FlinkAppStateEnum currentState) {
    /*
