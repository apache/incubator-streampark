...
/** Accepts and dispatches managed Flink release operations. */
public interface ManagedFlinkReleaseService {

    ManagedFlinkOperationView release(ManagedFlinkReleaseRequest request);
}
