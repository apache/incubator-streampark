...
/** Spring wiring for provider-neutral managed Flink services. */
@Configuration
public class ManagedFlinkProviderConfiguration {

    @Bean
    public ManagedFlinkProviderRegistry managedFlinkProviderRegistry(
                                                                     List<ManagedFlinkProvider> providers) {
        return new ManagedFlinkProviderRegistry(providers);
    }
}
