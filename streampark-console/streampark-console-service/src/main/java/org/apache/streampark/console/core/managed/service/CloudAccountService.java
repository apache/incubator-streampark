...
/** Manages encrypted cloud account metadata. */
public interface CloudAccountService {

    IPage<CloudAccountView> page(CloudAccountPageRequest request);

    CloudAccountView get(Long id);

    Long create(CloudAccountCreateRequest request);

    void update(CloudAccountUpdateRequest request);

    CloudAccountView test(CloudAccountVersionedIdRequest request);

    void disable(CloudAccountVersionedIdRequest request);

    void delete(CloudAccountVersionedIdRequest request);
}
