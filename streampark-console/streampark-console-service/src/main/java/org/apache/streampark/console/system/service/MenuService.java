...
public interface MenuService extends IService<Menu> {
   ...
   * @return permissions
   */
  List<String> listUserPermissions(Long userId, Long teamId);

  List<Menu> listUserMenus(Long userId, Long teamId);

  Map<String, Object> pageMenus(Menu menu);

  List<VueRouter<Menu>> listUserRouters(Long userId, Long teamId);
}
