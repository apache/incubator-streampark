...
/** Managed Flink environment registration and probe service. */
public interface ManagedFlinkEnvironmentService {

    Long create(ManagedFlinkEnvironmentCreateRequest request);

    void update(ManagedFlinkEnvironmentUpdateRequest request);

    ManagedFlinkEnvironmentView get(Long teamId, Long clusterId);

    List<ManagedFlinkEnvironmentView> list(ManagedFlinkEnvironmentListRequest request);

    void delete(ManagedFlinkEnvironmentVersionedIdRequest request);

    ManagedFlinkEnvironmentView probe(Long teamId, Long clusterId);
}
