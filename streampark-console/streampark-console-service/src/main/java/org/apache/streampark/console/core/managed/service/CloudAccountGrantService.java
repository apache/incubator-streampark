...
/** Manages explicit Team authorization for platform cloud accounts. */
public interface CloudAccountGrantService {

    void replaceGrants(CloudAccountGrantRequest request);

    List<CloudAccountTeamGrantView> listGrants(Long accountId);

    List<CloudAccountView> listAvailableAccounts(Long teamId);
}
