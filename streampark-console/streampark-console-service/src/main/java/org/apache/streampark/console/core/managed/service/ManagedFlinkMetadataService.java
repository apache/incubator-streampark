...
/** Team-authorized provider metadata facade. */
public interface ManagedFlinkMetadataService {

    ManagedFlinkCapability capability(ManagedFlinkMetadataRequest request);
