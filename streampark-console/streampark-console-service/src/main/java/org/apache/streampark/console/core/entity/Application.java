...
public class Application implements Serializable {
  ...
  public boolean isFlinkSqlJob() {
    return DevelopmentModeEnum.FLINK_SQL.getValue().equals(this.getJobType());
  }

  @JsonIgnore
  public boolean isFlinkSqlJobOrPyFlinkJob() {
    return DevelopmentModeEnum.FLINK_SQL.getValue().equals(this.getJobType())
        || DevelopmentModeEnum.PYFLINK.getValue().equals(this.getJobType());
  }

  @JsonIgnore
  public boolean isCustomCodeJob() {
    return DevelopmentModeEnum.CUSTOM_CODE.getValue().equals(this.getJobType());
  }
