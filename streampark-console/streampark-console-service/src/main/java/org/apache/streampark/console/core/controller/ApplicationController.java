...
public class ApplicationController {
    ...
    @ApiImplicitParams({
        @ApiImplicitParam(name = "id", value = "copy target app id", required = true, paramType = "form", dataTypeClass = Long.class),
        @ApiImplicitParam(name = "jobName", value = "name of the copied application", required = true, paramType = "form", dataTypeClass = String.class, defaultValue = ""),
        @ApiImplicitParam(name = "args", value = "commit parameters after copying", required = false, paramType = "form", dataTypeClass = String.class, defaultValue = "")})
    ...
    @ApiImplicitParams({
        @ApiImplicitParam(name = "id", value = "app Id", required = true, paramType = "form", dataTypeClass = Long.class),
        @ApiImplicitParam(name = "savePointed", value = "从savepoint或最新checkpoint恢复app", required = true, paramType = "form", dataTypeClass = Boolean.class, defaultValue = "false"),
        @ApiImplicitParam(name = "savePoint", value = "手动填写savepoint或最新checkpoint", required = true, paramType = "form", dataTypeClass = String.class, defaultValue = ""),
        @ApiImplicitParam(name = "flameGraph", value = "flame Graph support", required = true, paramType = "form", dataTypeClass = Boolean.class, defaultValue = "false"),
        @ApiImplicitParam(name = "allowNonRestored", value = "ignore savepoint then cannot be restored", required = true, paramType = "form", dataTypeClass = Boolean.class, defaultValue = "false")})
    ...
    @ApiImplicitParams({
        @ApiImplicitParam(name = "id", value = "app Id", required = true, paramType = "form", dataTypeClass = Long.class),
        @ApiImplicitParam(name = "savePointed", value = "trigger savePoint before taking stoping", required = true, paramType = "form", dataTypeClass = Boolean.class, defaultValue = "false"),
        @ApiImplicitParam(name = "savePoint", value = "savepoint path", paramType = "form", dataTypeClass = String.class, defaultValue = "hdfs:///tm/xxx"),
        @ApiImplicitParam(name = "drain", value = "send max watermark before canceling", required = true, paramType = "form", dataTypeClass = Boolean.class, defaultValue = "false")})
