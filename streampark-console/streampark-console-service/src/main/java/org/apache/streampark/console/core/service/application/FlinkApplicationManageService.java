 ...
 */
public interface FlinkApplicationManageService extends IService<FlinkApplication> {
     ...
     */
    IPage<FlinkApplication> page(FlinkApplication appParam, RestRequest request);
     ...
     */
    boolean create(FlinkApplication appParam) throws IOException;
     ...
     */
    Long copy(FlinkApplication appParam) throws IOException;
     ...
     */
    boolean update(FlinkApplication appParam);
     ...
     */
    void toEffective(FlinkApplication appParam);
     ...
     */
    void persistMetrics(FlinkApplication appParam);
     ...
     */
    boolean mapping(FlinkApplication appParam);
     ...
     */
    boolean checkBuildAndUpdate(FlinkApplication appParam);
     ...
     */
    FlinkApplication getApp(Long id);
     ...
     */
    void updateRelease(FlinkApplication appParam);
     ...
     */
    void clean(FlinkApplication appParam);
     ...
     */
    List<FlinkApplication> listByProjectId(Long id);
     ...
     */
    List<FlinkApplication> listByTeamId(Long teamId);
