...
public class CatalogController {
    ...
    public RestResponse create(Catalog catalog) throws IOException {
    ...
    public RestResponse list(Catalog catalog, RestRequest request) {
        IPage<Catalog> catalogList = catalogService.page(catalog, request);
    ...
    public RestResponse remove(Catalog catalog, RestRequest request) {
    ...
    public RestResponse remove(Catalog catalog) {
        Long userId = ServiceHelper.getUserId();
