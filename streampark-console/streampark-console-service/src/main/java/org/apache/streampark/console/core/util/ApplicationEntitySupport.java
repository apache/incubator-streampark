...
/**
 * Read-only adapter that exposes derived application values outside persistence entities.
 *
 * <p>The default methods delegate calculations to {@link ApplicationEntityUtils}; implementing
 * entities provide only their persisted source fields.
 */
