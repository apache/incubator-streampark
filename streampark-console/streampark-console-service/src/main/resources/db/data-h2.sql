...
insert into `t_menu` values (160000, 0, 'menu.variable', '/variable', 'variable/View', null, null, '0', 1, 4, now(), now());
insert into `t_menu` values (170000, 0, 'menu.resource', '/resource', 'resource/View', null, null, '0', 1, 3, now(), now());
...
insert into `t_menu` values (120301, 160000, 'add', NULL, NULL, 'variable:add', NULL, '1', 1, NULL, now(), now());
insert into `t_menu` values (120302, 160000, 'update', NULL, NULL, 'variable:update', NULL, '1', 1, NULL, now(), now());
insert into `t_menu` values (120303, 160000, 'delete', NULL, NULL, 'variable:delete', NULL, '1', 1, NULL, now(), now());
insert into `t_menu` values (120304, 160000, 'depend apps', 'variable/depend_apps', 'variable/DependApps', 'variable:depend_apps', '', '0', 0, NULL, now(), now());
insert into `t_menu` values (120305, 160000, 'show original', NULL, NULL, 'variable:show_original', NULL, '1', 1, NULL, now(), now());
insert into `t_menu` values (120306, 160000, 'view', NULL, NULL, 'variable:view', NULL, '1', 1, null, now(), now());
insert into `t_menu` values (120307, 160000, 'depend view', null, null, 'variable:depend_apps', null, '1', 1, NULL, now(), now());
insert into `t_menu` values (120401, 170000, 'add', NULL, NULL, 'resource:add', NULL, '1', 1, NULL, now(), now());
insert into `t_menu` values (120402, 170000, 'update', NULL, NULL, 'resource:update', NULL, '1', 1, NULL, now(), now());
insert into `t_menu` values (120403, 170000, 'delete', NULL, NULL, 'resource:delete', NULL, '1', 1, NULL, now(), now());
...
insert into `t_role_menu` (role_id, menu_id) values (100001, 160000);
...
insert into `t_role_menu` (role_id, menu_id) values (100001, 170000);
...
insert into `t_role_menu` (role_id, menu_id) values (100002, 160000);
...
insert into `t_role_menu` (role_id, menu_id) values (100002, 170000);
