...
-- ----------------------------
insert into `t_flink_project` values (100000, 100000, 'streampark-quickstart', '1', 'https://github.com/apache/incubator-streampark-quickstart', 'main', null, null, null, null, null, 1, 1, null, 'streampark-quickstart', -1, now(), now());
