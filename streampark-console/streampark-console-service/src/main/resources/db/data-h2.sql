...
insert into `t_menu` values (120000, 0, 'Apache Flink', '/flink', 'PageView', null, null, '0', 1, 5, now(), now());
insert into `t_menu` values (130000, 0, 'menu.setting', '/setting', 'PageView', null, 'setting', '0', 1, 2, now(), now());
insert into `t_menu` values (150000, 0, 'Apache Spark', '/spark', 'PageView', null, null, '0', 1, 6, now(), now());
insert into `t_menu` values (140000, 0, 'menu.resource', '/resource', 'PageView', null, 'github', '0', 1, 3, now(), now());
insert into `t_menu` values (140100, 140000, 'resource.project', '/resource/project', 'resource/project/View', null, 'github', '0', 1, 3, now(), now());
insert into `t_menu` values (140200, 140000, 'resource.variable', '/resource/variable', 'resource/variable/View', null, null, '0', 1, 4, now(), now());
insert into `t_menu` values (140300, 140000, 'resource.material', '/resource/resource', 'resource/material/View', null, null, '0', 1, 3, now(), now());
...
insert into `t_menu` values (120101, 140100, 'add', '/project/add', 'project/Add', 'project:create', '', '0', 0, null, now(), now());
insert into `t_menu` values (120102, 140100, 'build', null, null, 'project:build', null, '1', 1, null, now(), now());
insert into `t_menu` values (120103, 140100, 'delete', null, null, 'project:delete', null, '1', 1, null, now(), now());
insert into `t_menu` values (120104, 140100, 'edit', '/project/edit', 'project/Edit', 'project:update', null, '0', 0, null, now(), now());
insert into `t_menu` values (120105, 140100, 'view', null, null, 'project:view', null, '1', 1, null, now(), now());
...
insert into `t_menu` values (120301, 140200, 'add', NULL, NULL, 'variable:add', NULL, '1', 1, NULL, now(), now());
insert into `t_menu` values (120302, 140200, 'update', NULL, NULL, 'variable:update', NULL, '1', 1, NULL, now(), now());
insert into `t_menu` values (120303, 140200, 'delete', NULL, NULL, 'variable:delete', NULL, '1', 1, NULL, now(), now());
insert into `t_menu` values (120304, 140200, 'depend apps', 'variable/depend_apps', 'variable/DependApps', 'variable:depend_apps', '', '0', 0, NULL, now(), now());
insert into `t_menu` values (120305, 140200, 'show original', NULL, NULL, 'variable:show_original', NULL, '1', 1, NULL, now(), now());
insert into `t_menu` values (120306, 140200, 'view', NULL, NULL, 'variable:view', NULL, '1', 1, null, now(), now());
insert into `t_menu` values (120307, 140200, 'depend view', null, null, 'variable:depend_apps', null, '1', 1, NULL, now(), now());
insert into `t_menu` values (120401, 140300, 'add', NULL, NULL, 'resource:add', NULL, '1', 1, NULL, now(), now());
insert into `t_menu` values (120402, 140300, 'update', NULL, NULL, 'resource:update', NULL, '1', 1, NULL, now(), now());
insert into `t_menu` values (120403, 140300, 'delete', NULL, NULL, 'resource:delete', NULL, '1', 1, NULL, now(), now());
...
insert into `t_role_menu` (role_id, menu_id) values (100001, 140200);
...
insert into `t_role_menu` (role_id, menu_id) values (100001, 140300);
...
insert into `t_role_menu` (role_id, menu_id) values (100002, 140200);
