...
create table if not exists "public"."t_access_token" (
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_alert_config_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_alert_config" (
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_flink_app_backup_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_flink_app_backup" (
...
-- ----------------------------
create table if not exists "public"."t_app_build_pipe" (
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_flink_app_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_flink_app" (
  "id" int8 not null,
  "team_id" int8,
  "job_type" int2,
  "deploy_mode" int2,
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_flink_cluster_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_flink_cluster" (
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_flink_config_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_flink_config" (
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_flink_effective_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_flink_effective" (
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_flink_env_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_flink_env" (
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_app_log_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_app_log" (
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_flink_project_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_flink_project" (
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_flink_savepoint_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_flink_savepoint" (
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_flink_sql_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_flink_sql" (
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_distributed_task_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;
create table if not exists "public"."t_distributed_task"
(
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_menu_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_message_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_message" (
...
create sequence if not exists "public"."streampark_t_team_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;
...
-- Table of t_variable
-- ----------------------------
create sequence if not exists "public"."streampark_t_variable_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_variable" (
...
-- Table of t_resource
-- ----------------------------
create sequence if not exists "public"."streampark_t_resource_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_resource" (
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_role_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_role_menu_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_role_menu" (
...
-- ----------------------------
create table if not exists "public"."t_setting" (
  "order_num" int4,
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_user_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_member_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_external_link_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_external_link" (
...
-- ----------------------------
create sequence if not exists "public"."streampark_t_yarn_queue_id_seq"
    increment 1 start 10000 cache 1 minvalue 10000 maxvalue 9223372036854775807;

create table if not exists "public"."t_yarn_queue" (
