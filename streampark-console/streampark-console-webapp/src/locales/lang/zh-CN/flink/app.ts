...
export default {
  ...
  managed: {
    ...
    engineVersion: '引擎版本',
    jar: '应用 JAR',
    uploadDependency: '上传 JAR',
    dependencyPlaceholder: '选择或上传依赖 JAR',
    dependencyJarOnly: '仅支持上传 JAR 依赖文件。',
    dependencyAlreadyExists: '已存在同名资源，请重命名后再上传。',
    dependencyUploadDescription: '从 Managed Flink 应用表单上传的依赖',
    dependencyUploadSuccess: '依赖 JAR 上传成功',
    dependencyUploadInvalid: '上传的文件不是有效的依赖 JAR',
    resourceConfig: '资源配置',
