...
export default {
  ...
  form: {
    ...
    projectBuildType: 'Project Build Type',
    projectTypePlaceholder: 'please select project type',
    projectBuildTypePlaceholder: 'please select project build type，Gradle needs to be installed separately in the StreamPark environment',
    cvs: 'CVS',
    ...
    pom: 'POM',
    pomPlaceholder:
      'By default,lookup pom.xml in root path,You can manually specify the module to compile pom.xml。Gradle does not support this feature',
    buildArgs: 'Build Argument',
    buildArgsPlaceholder: 'Build parameters: In the Maven environment, just enter the compile parameters, such as: -Pprod; in the Gradle environment, you need to enter the complete command, such as: ./gradlew shadowJar -p project_a',
  ...
  operationTips: {
    ...
    projectBuildTypeIsRequiredMessage: 'Project Build Type is required',
