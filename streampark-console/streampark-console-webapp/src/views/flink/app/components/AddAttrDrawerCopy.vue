...
<script lang="ts" name="AddAttrDrawer">
...
export default defineComponent({
  name: 'MenuDrawer',
  components: { BasicDrawer, Icon, BasicForm, PomTemplateTab, UseSysHadoopConf, Dependency },
  emits: ['addAttrsuccess', 'register', 'addAttrFailed'],
  setup(_, { emit }) {
    const { t } = useI18n();
    ...
    async function handleSubmit() {
      try {
        ...
        const params = { ...oldValues, ...values, dependency }
    ...
    return { t, registerDrawer, registerForm, getTitle, handleClose, handleSubmit, isSubmitConfig, k8sTemplate, flinkEnvs, getAttrCreateFormSchema };
  }
})
</script>
<template>
