    ...
    <a-form
      ...
      <a-form-item
        ...
        <a-alert
          type="info">
          <template slot="message">
            <svg-icon name="flink" style="color: #108ee9"/>&nbsp;&nbsp;StreamPark Flink
          </template>
        </a-alert>
      </a-form-item>
              ...
              <template>
                <a-row>
                  <p class="conf-desc">
                    <span class="note-info" style="margin-bottom: 12px">
                      <a-tag color="#2db7f5" class="tag-note">Note</a-tag>
                      Enter the host-ip mapping value in the format <b>[hostname:ip]</b>, e.g: chd01.streampark.com:192.168.112.233
                    </span>
                  </p>
                </a-row>
                <a-row>
