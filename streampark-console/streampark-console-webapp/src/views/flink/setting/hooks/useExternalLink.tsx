...
import ExternalLinkBadge from '../components/ExternalLinkBadge.vue';
  ...
  return (
    <Space>
      ...
      <ExternalLinkBadge
        ...
        message={t('flink.setting.externalLink.form.badgeName')}
...
export const renderPreview = (formModel: Recordable) => {
  return (
    <ExternalLinkBadge
      ...
      message={formModel['badgeName'] || t('flink.setting.externalLink.form.badgeName')}
