...
export function useDataSource(
  ...
  async function fetch(opt?: FetchParams) {
    ...
    try {
      ...
      // If the data becomes less, resulting in the total number of pages becoming less and less than the currently selected page number, the page number obtained through getPaginationRef is incorrect, and the correct page number needs to be obtained and executed again
      if (resultTotal) {
