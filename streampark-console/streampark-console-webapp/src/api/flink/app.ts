...
enum APP_API {
  ...
  OPTION_LOG = '/flink/app/option_log',
  DELETE_LOG = '/flink/app/delete_log',
  CHECK_SAVEPOINT_PATH = '/flink/app/check_savepoint_path',
}
