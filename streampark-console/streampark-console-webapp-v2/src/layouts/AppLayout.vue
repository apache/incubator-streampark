...
const showAside = computed(() => {
    if (props.isMobile || props.mode === 'full-content' || props.mode === 'horizontal') return false
...
<template>
    ...
    >
        ...
        >
            ...
            <div
                class="sp-layout__aside-body"
                :class="{ 'sp-layout__aside-body--split': showSidebarExtra }"
            >
