...
import type { AppListResponse, CancelParam, CreateParams, DashboardResponse } from '@/types/api/flink/app.type'
...
export function fetchCheckSavepointPath(data: { id?: string, savepointPath?: string }) {
  return request.Post<{ data?: boolean, message?: string }>('/flink/app/check/savepoint_path', data)
}
