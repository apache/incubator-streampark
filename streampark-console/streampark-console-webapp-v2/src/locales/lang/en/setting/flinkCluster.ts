...
export default {
    ...
    placeholder: {
        ...
        k8sConf: '~/.kube/config',
        flinkImage:
            'Please enter the tag of Flink base docker image, such as: flink:1.20-scala_2.12-java11',
    ...
    operateMessage: {
        ...
        flinkClusterIsRemoved: 'The current cluster is removed',
        flinkClusterIsCanceling: 'The current cluster is canceling',
        flinkClusterIsShutdown: 'The current cluster is shutdown',
    },
    view: {
        clusterId: 'ClusterId',
    },
