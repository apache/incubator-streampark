...
export default {
    ...
    dragUploadTip:
        'Supports single upload. You can upload local jar here to support the current job',
    ...
    addAppTips: {
        ...
        sparkImagePlaceholder:
            'Please enter the tag of the spark base Docker image, e.g., spark:3.5.0-java17',
