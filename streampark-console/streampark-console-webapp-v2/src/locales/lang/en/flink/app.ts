...
export default {
    ...
    restoreModeTip:
        'restore mode is supported since Flink 1.17+, usually you do not have to set this parameter',
    ...
    detail: {
        ...
        nullAccessToken:
            "The current user's token not exist, please contact the administrator to add",
    ...
    operation: {
        ...
        forceStartBuildState:
            'The current build state requires confirmation. Are you sure to force the application to run?',
    ...
    noteInfo: {
        ...
        checkPointAlertRequired: 'trigger action is alert,Fault Alert Template must not be empty',
