...
export default {
    ...
    cpMaxFailureInterval: '最大失败次数',
    cpFailureRateInterval: 'checkpoint失败间隔',
    cpFailureAction: '失败处理动作',
    ...
    hadoopTab: 'Hadoop',
    hiveTab: 'Hive',
    useSysHadoopConfTip1: '自动从系统环境参数复制配置文件',
    useSysHadoopConfTip2: '将 HADOOP_CONF_PATH 和 HIVE_CONF_PATH 复制到 Flink Docker 镜像',
    ...
    dependencyValidate: {
        invalidTitle: '依赖无效',
        invalidContent:
            '当前 flink scala 版本: <strong>{scalaVersion}</strong>，部分依赖的 scala 版本无效，依赖列表:',
    },
    status: '运行状态',
    startTime: '启动时间',
    endTime: '结束时间',
    hadoopUser: 'Hadoop User',
    restoreModeTip: '自 Flink 1.17+ 起支持 restore mode，通常无需设置该参数',
    restoreModePlaceholder: '请选择 restore 模式',
    resourceFromPlaceholder: '请选择资源来源',
    resourceFromProject: '项目',
    resourceFromUpload: '上传',
    resourceFromProjectHint: '(从项目构建)',
    resourceFromUploadHint: '(上传本地作业)',
    release: {
    ...
    releaseHint: {
        failed: '发布失败',
        needRelease: '当前作业需要发布',
        releasing: '正在发布',
        needRestart: '发布完成，需要重启',
        needRollback: '作业已回滚，需要重新发布',
    },
    runState: {
        added: '新增作业',
        initializing: '初始化',
    ...
    view: {
        ...
        ignoreRestored: '忽略失败',
        ignoreRestoredTip:
            '当状态恢复失败时跳过错误，作业继续运行, 同参数：-allowNonRestoredState(-n)',
    },
    pod: {
        choice: '选择',
        init: '初始化内容',
        ...
        jmTab: 'JM Pod 模板',
        tmTab: 'TM Pod 模板',
        historyTitle: 'Pod 模板历史',
        jmHistoryTitle: 'JobManager Pod 模板历史',
        tmHistoryTitle: 'TaskManager Pod 模板历史',
        hostAliasTitle: 'Pod 模板 HostAlias',
        jmHostAliasTitle: 'JM Pod 模板 HostAlias',
        tmHostAliasTitle: 'TM Pod 模板 HostAlias',
        hostAliasNote: '提示',
        hostAliasHint: '请输入 host-ip 映射，格式为 [hostname:ip]',
        preview: '预览',
    },
    flinkSql: {
        preview: '内容预览',
    ...
    editStreamPark: {
        ...
        sqlCheck: 'SQL 检查错误',
        twoVersionsRequired: '必须选择两个版本进行比较',
        editError: '编辑错误',
        sqlHistory: 'SQL 历史',
    },
    savepoint: {
        requestSent: 'Savepoint 请求已发送。',
        customSavepointLabel: '自定义 Savepoint',
        nativeFormatLabel: 'Native Format',
        customPathPlaceholder: '可选：输入自定义 savepoint 路径',
    },
    home: {
        removed: '当前 Flink Home 已移除。',
    },
    action: {
        abortJobStarting: '正在终止作业启动',
        deployModeError: 'deployMode 错误。',
        onlyJarFiles: '只能上传 jar 文件，请检查文件。',
    },
    operation: {
        edit: '编辑作业',
        release: '发布作业',
        ...
        starting: '当前作业正在启动中',
        copyModalTitle: '复制作业',
        copyJobNameLabel: '作业名称',
        copyJobNamePlaceholder: '新作业名称',
        copySuccess: '复制成功',
        copyFail: '复制失败',
        mappingModalTitle: '重新映射作业',
        mappingJobNameLabel: '作业名称',
        ...
        mappingJobIdRequired: 'JobId 不能为空',
        mappingSuccess: '作业映射请求已发送',
        abortConfirm: '确定要终止当前操作吗？',
        forceStartNoBuild: '当前应用没有构建记录，确定强制启动吗？',
        forceStartBuildState: '当前构建状态需要确认，确定强制启动吗？',
        deleteSuccess: '删除成功',
        deleting: '删除中...',
    },
    dashboard: {
    ...
    addAppTips: {
        ...
        serviceAccountPlaceholder: '请输入 Kubernetes 服务账号',
        ...
        flinkImagePlaceholder: '请输入Flink基础docker镜像的标签,如:flink:1.20-scala_2.12-java11',
        ...
        configTagPlaceholder: '请选择标签',
        configSelectPlaceholder: '请选择配置',
        configFileInvalid: '配置文件必须是 (.properties|.yaml|.yml |.conf)',
        configRequired: '请选择配置',
        compareConfPlaceholder: '请选择要比较的配置版本',
        resolveOrderRequired: '类加载顺序必填',
        searchHistoryUploads: '搜索历史上传',
        searchSystemHosts: '搜索系统 Host',
        useExisting: '使用已有',
        reselect: '重新选择',
        jarSelectPlaceholder: '请选择 Jar',
        jarSelectRequired: '请选择 Jar',
    },
    ...
    noteInfo: {
        ...
        processMemoryGroup: '进程总内存',
        totalMemoryGroup: 'Flink 总内存',
        checkPointAlertRequired: '触发操作为告警时，故障告警模板不能为空',
        checkPointOptionsRequired: '选项需全部填写或全部为空',
        dynamicProperties:
