...
export default {
    ...
    placeholder: {
        ...
        flinkImage: '请输入 Flink 基础 docker 镜像的标签，如：flink:1.20-scala_2.12-java11',
        ...
        clusterDescription: '集群描述信息, 如: 生产flink 1.20集群',
    },
    required: {
        address: '必须填写集群地址',
        deployMode: '部署模式必填',
    ...
    operateMessage: {
        ...
        flinkClusterIsRemoved: '当前集群已删除',
        flinkClusterIsCanceling: '当前集群正在停止',
        flinkClusterIsShutdown: '当前集群已关闭',
    },
    view: {
        clusterId: '集群ID',
    },
