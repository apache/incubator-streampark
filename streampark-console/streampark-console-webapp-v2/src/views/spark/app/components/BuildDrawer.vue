            ...
            <n-timeline v-if="pipeline?.steps?.length">
                ...
                >
                    ...
                    <template v-if="pipeline?.pipeType === 2 && docker !== null">
                        <template v-if="stepItem.seq === 5 && docker.pull?.layers">
                            <BuildLayer
                        ...
                        <template v-else-if="stepItem.seq === 6 && docker.build?.steps">
                        ...
                        <template v-else-if="stepItem.seq === 7 && docker.push?.layers">
                            <BuildLayer
