        ...
        <n-descriptions :column="2" label-placement="left" class="alert-detail-desc">
          ...
          <n-descriptions-item :label="t('setting.alarm.dingtalkAccessToken')" :span="2">
            <n-space align="center" :size="8">
              ...
              <n-button v-if="dingTalk.token" quaternary size="tiny" @click="copyText(dingTalk.token)">
                <template #icon>
          ...
          <n-descriptions-item :label="t('setting.alarm.secretToken')" :span="2">
            <n-space align="center" :size="8">
              ...
              <n-button v-if="dingTalk.secretToken" quaternary size="tiny" @click="copyText(dingTalk.secretToken)">
                <template #icon>
                  <n-icon><IonIcon name="CopyOutline" /></n-icon>
                </template>
              </n-button>
        ...
        <n-descriptions :column="1" label-placement="left" class="alert-detail-desc">
          <n-descriptions-item :label="t('setting.alarm.weChattoken')">
            <n-space align="center" :size="8">
              ...
              <n-button v-if="weChat.token" quaternary size="tiny" @click="copyText(weChat.token)">
                <template #icon>
                  <n-icon><IonIcon name="CopyOutline" /></n-icon>
                </template>
              </n-button>
        ...
        <n-descriptions :column="2" label-placement="left" class="alert-detail-desc">
          <n-descriptions-item :label="t('setting.alarm.larkToken')" :span="2">
            <n-space align="center" :size="8">
              ...
              <n-button v-if="lark.token" quaternary size="tiny" @click="copyText(lark.token)">
                <template #icon>
                  <n-icon><IonIcon name="CopyOutline" /></n-icon>
                </template>
              </n-button>
          ...
          <n-descriptions-item :label="t('setting.alarm.larkSecretToken')" :span="2">
            <n-space align="center" :size="8">
              ...
              <n-button v-if="lark.secretToken" quaternary size="tiny" @click="copyText(lark.secretToken)">
                <template #icon>
                  <n-icon><IonIcon name="CopyOutline" /></n-icon>
                </template>
              </n-button>
