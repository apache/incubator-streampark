...
const rules: FormRules = {
  badgeName: [{ required: true, message: t('setting.externalLink.form.badgeNameIsRequired'), trigger: 'blur' }],
  linkUrl: [{ required: true, message: t('setting.externalLink.form.linkUrlIsRequired'), trigger: 'blur' }],
  badgeColor: [{ required: true, message: t('setting.externalLink.form.badgeColorIsRequired'), trigger: 'change' }],
}
  ...
  >
    <n-form ref="formRef" :model="formModel" :rules="rules" label-placement="top">
      <n-form-item :label="t('setting.externalLink.form.badgeLabel')" path="badgeLabel">
        <n-input v-model:value="formModel.badgeLabel" :placeholder="t('setting.externalLink.form.badgeLabelPlaceholder')" />
      </n-form-item>
      <n-form-item :label="t('setting.externalLink.form.badgeName')" path="badgeName">
        <n-input v-model:value="formModel.badgeName" :placeholder="t('setting.externalLink.form.badgeNamePlaceholder')" />
      </n-form-item>
      <n-form-item :label="t('setting.externalLink.form.linkUrl')" path="linkUrl">
        <n-input v-model:value="formModel.linkUrl" :placeholder="t('setting.externalLink.form.linkUrlPlaceholder')" />
        <template #feedback>
