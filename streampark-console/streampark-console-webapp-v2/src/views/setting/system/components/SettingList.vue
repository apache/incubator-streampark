      ...
      <div class="setting-row">
        ...
        <div class="setting-value">
          <template v-if="item.type === 1">
            ...
            />
            <span v-else>
              <template v-if="isPassword(item) && item.settingValue !== null">********</template>
        ...
        <div v-if="item.type === 1" v-auth="'setting:update'">
          <n-button v-if="!item.submitting" circle type="primary" @click="handleEdit(item)">
            <SvgIcon name="edit" />
          </n-button>
