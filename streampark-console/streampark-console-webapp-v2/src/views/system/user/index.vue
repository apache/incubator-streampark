...
import { fetchDeleteUser, fetchResetUserPassword, fetchUserList } from '@/service'
    ...
    },
    {
        ...
        render(row) {
            ...
            return h(
                ...
                {
                    default: () =>
                        effective ? t('system.user.effective') : t('system.user.locked'),
                },
            )
        },
    },
...
<template>
    ...
    <UserDetailModal v-model:show="detailVisible" :record="detailRecord" />
</template>
