...
const typeMeta = computed(() => {
    ...
    if (props.jobType === SparkJobTypeEnum.JAR) return { label: 'JAR', className: 'app-type-jar' }
    if (props.jobType === SparkJobTypeEnum.SQL) return { label: 'SQL', className: 'app-type-sql' }
