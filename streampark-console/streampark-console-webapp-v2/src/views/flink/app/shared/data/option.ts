...
const options: FlinkOptionItem[] = [
    ...
    },
    {
        ...
        validator: (_rule, value, callback) => {
            if (!value) {
                callback(
                    new Error('jvm-overhead.fraction is require or you can delete this option.'),
                )
            } else {
                callback()
            }
    ...
    },
    {
        ...
        validator: (_rule, value, callback) => {
            if (!value) {
                callback(
                    new Error('framework.off-heap.size is required or you can delete this option'),
                )
            } else {
                callback()
            }
    ...
    },
    {
        ...
        validator: (_rule, value, callback) => {
            if (!value) {
                callback(
                    new Error('jvm-overhead.fraction is required or you can delete this option'),
                )
            } else {
                callback()
            }
    ...
    },
    {
        ...
        validator: (_rule, value, callback) => {
            if (!value) {
                callback(
                    new Error('memory.network.fraction is required or you can delete this option'),
                )
            } else {
                callback()
            }
