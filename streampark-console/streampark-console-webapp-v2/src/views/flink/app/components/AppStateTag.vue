...
const tagStyle = computed(() => {
    if (tagWidth.value > 0) return { minWidth: `${tagWidth.value}px`, textAlign: 'center' as const }
    return {}
})
...
function showTaskColumn(data: Partial<AppListRecord>) {
    return (
        [AppStateEnum.RESTARTING, AppStateEnum.RUNNING, AppStateEnum.FAILING].includes(
            data.state!,
        ) || data.optionState === OptionStateEnum.SAVEPOINTING
    )
}

function overviewEntries(overview?: Recordable) {
    if (!overview) return [] as Array<{ key: string; value: unknown; meta: StateMeta }>
...
@keyframes deploying-color {
    0% {
        ...
        box-shadow:
            0 0 1px #1abbdc,
            inset 0 0 2px #1abbdc;
    }
    100% {
        border-color: #1abbdc;
        box-shadow:
            0 0 10px #1abbdc,
            inset 0 0 5px #1abbdc;
    }
}
...
@keyframes initializing-color {
    0% {
        ...
        box-shadow:
            0 0 1px #738df8,
            inset 0 0 2px #738df8;
    }
    100% {
        border-color: #738df8;
        box-shadow:
            0 0 10px #738df8,
            inset 0 0 5px #738df8;
    }
}
...
@keyframes starting-color {
    0% {
        ...
        box-shadow:
            0 0 1px #1ab58e,
            inset 0 0 2px #1ab58e;
    }
    100% {
        border-color: #1ab58e;
        box-shadow:
            0 0 10px #1ab58e,
            inset 0 0 5px #1ab58e;
    }
}
...
@keyframes restarting-color {
    0% {
        ...
        box-shadow:
            0 0 1px #13c2c2,
            inset 0 0 2px #13c2c2;
    }
    100% {
        border-color: #13c2c2;
        box-shadow:
            0 0 10px #13c2c2,
            inset 0 0 5px #13c2c2;
    }
}
...
@keyframes running-color {
    0% {
        ...
        box-shadow:
            0 0 1px #52c41a,
            inset 0 0 2px #52c41a;
    }
    100% {
        border-color: #52c41a;
        box-shadow:
            0 0 10px #52c41a,
            inset 0 0 5px #52c41a;
    }
}
...
@keyframes failing-color {
    0% {
        ...
        box-shadow:
            0 0 1px #fa541c,
            inset 0 0 2px #fa541c;
    }
    100% {
        border-color: #fa541c;
        box-shadow:
            0 0 10px #fa541c,
            inset 0 0 5px #fa541c;
    }
}
...
@keyframes cancelling-color {
    0% {
        ...
        box-shadow:
            0 0 1px #faad14,
            inset 0 0 2px #faad14;
    }
    100% {
        border-color: #faad14;
        box-shadow:
            0 0 10px #faad14,
            inset 0 0 5px #faad14;
    }
}
...
@keyframes reconciling-color {
    0% {
        ...
        box-shadow:
            0 0 1px #eb2f96,
            inset 0 0 2px #eb2f96;
    }
    100% {
        border-color: #eb2f96;
        box-shadow:
            0 0 10px #eb2f96,
            inset 0 0 5px #eb2f96;
    }
}
</style>
