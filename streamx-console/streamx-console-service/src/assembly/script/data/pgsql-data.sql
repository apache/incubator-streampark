...
insert into "public"."t_menu" values (100013, 0, 'StreamX', '/flink', 'PageView', null, 'build', 0, true, 2, now(), null);
...
insert into "public"."t_menu" values (100021, 100013, 'Edit StreamX App', '/flink/app/edit_streamx', 'flink/app/EditStreamX', 'app:update', '', 0, false, null, now(), null);
