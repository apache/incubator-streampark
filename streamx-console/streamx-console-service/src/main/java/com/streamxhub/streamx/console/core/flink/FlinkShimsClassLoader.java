 ...
 * under the License.
 */
package com.streamxhub.streamx.console.core.flink;
 ...
 * override that.
 */
public final class FlinkShimsClassLoader extends URLClassLoader {
    ...
    public FlinkShimsClassLoader(URL[] urls, ClassLoader parent) {
        this(urls, parent, NOOP_EXCEPTION_HANDLER);
    }

    public FlinkShimsClassLoader(
        URL[] urls,
        ClassLoader parent,
