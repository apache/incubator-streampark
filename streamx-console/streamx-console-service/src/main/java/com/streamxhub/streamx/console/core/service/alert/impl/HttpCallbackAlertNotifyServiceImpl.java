...
public class HttpCallbackAlertNotifyServiceImpl implements AlertNotifyService {
    ...
    private Object sendMessage(HttpCallbackParams params, Map<String, Object> body) throws AlertException {
        ...
        try {
            ...
            throw new AlertException(String.format("Failed to request httpCallback alert, url:%s", url), e);
        }

        if (response == null) {
            throw new AlertException(String.format("Failed to request httpCallback alert, url:%s", url));
        }
