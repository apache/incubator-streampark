...
create table if not exists `t_flink_env` (
  ...
  `version` varchar(50)  not null comment 'the version number corresponding to flink',
  `scala_version` varchar(50)  not null comment 'the scala version number corresponding to flink',
  `flink_conf` text  not null comment 'flink conf configuration content',
...
create table if not exists `t_menu` (
  ...
  `display` char(2)  not null default '1' comment 'whether the menu is displayed',
