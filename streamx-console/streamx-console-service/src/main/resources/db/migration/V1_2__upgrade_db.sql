...
-- ----------------------------
-- Table structure for t_flink_version
-- ----------------------------
DROP TABLE IF EXISTS `t_flink_version`;
CREATE TABLE `t_flink_version` (
`ID` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
`FLINK_NAME` varchar(255) DEFAULT NULL COMMENT 'Flink实例名称',
`DESCRIPTION` varchar(255) NOT NULL COMMENT '描述信息',
`FLINK_HOME` varchar(255) DEFAULT NULL COMMENT 'Flink Home路径',
`VERSION` varchar(50) NOT NULL COMMENT 'Flink对应的版本号',
`FLINK_CONF` text DEFAULT NULL COMMENT 'flink-conf配置内容',
