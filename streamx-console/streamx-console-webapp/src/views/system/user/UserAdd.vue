<template>
  <a-drawer
    ...
    <a-form :form="form">
      ...
      <a-form-item label="Mail" v-bind="formItemLayout">
        <a-input
      ...
      <a-form-item label="Mobile" v-bind="formItemLayout">
        <a-input
      ...
      <a-form-item label="Gender" v-bind="formItemLayout">
        <a-radio-group
          ...
          <a-radio value="2">secret</a-radio>
        </a-radio-group>
      </a-form-item>
    </a-form>
    <div class="drawer-bootom-button">
      <a-button style="margin-right: .8rem" @click="onClose">Cancel</a-button>
      <a-button @click="handleSubmit" type="primary" :loading="loading">Submit</a-button>
    </div>
  </a-drawer>
</template>
<script>
