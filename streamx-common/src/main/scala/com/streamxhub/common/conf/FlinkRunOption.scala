...
object FlinkRunOption {
  ...
  val DETACHED_OPTION = new Option(
    "d",
    "detached",
    false,
  ...
  /**
    ...
    */
  @deprecated val YARN_DETACHED_OPTION = new Option(
    "yd",
    "yarndetached",
    false,
  ...
  val SCHEDULED_OPTION = new Option(
    "s",
    "scheduled",
    false,
  ...
  val PYMODULE_OPTION = new Option(
    "pym",
    "pyModule",
    true,
  ...
  val DYNAMIC_PROPERTIES = Option
    .builder("D")
    .argName("property=value")
    .numberOfArgs(2)
    .valueSeparator('=')
    .desc(
      "Allows specifying multiple generic configuration options. The available options can be found at https://ci.apache.org/projects/flink/flink-docs-stable/ops/config.html"
    )
    .build
  ...
  def buildGeneralOptions(options: Options): Options = {
    ...
    options.addOption(
      new Option("v", "verbose", false, "This option is deprecated.")
    )
    options
  }
