...
object RedisUtils extends Logger {
  ...
  /**
    ...
    * @return
    */
  def exists(key: String)(implicit endpoint: RedisEndpoint): Boolean =
    doRedis(_.exists(key))

  def hexists(key: String, field: String, func: () => Unit = null)(
      implicit endpoint: RedisEndpoint
  ): Boolean = doRedis(_.hexists(key, field), func)
  ...
  /**
    ...
    * @return
    */
  def get(key: String)(implicit endpoint: RedisEndpoint): String =
    doRedis(_.get(key))

  def hget(key: String, field: String)(
      implicit endpoint: RedisEndpoint
  ): String = doRedis(_.hget(key, field))
  ...
  def setex(
      ...
      ttl: JInt = null,
      func: () => Unit = null
  )(implicit endpoint: RedisEndpoint): String =
  ...
  def mget(keys: Array[String])(
      implicit endpoint: RedisEndpoint
  ): Array[String] = doRedis(_.mget(keys: _*).asScala.toArray)
  ...
  /**
    ...
    * @return
    */
  def del(key: String, func: () => Unit = null)(
      implicit endpoint: RedisEndpoint
  ): Long = doRedis(_.del(key), func)
  ...
  def hmget(key: String, fields: String*)(
      implicit endpoint: RedisEndpoint
  ): List[String] = doRedis(_.hmget(key, fields: _*).asScala.toList)
  ...
  def hgetAll(key: String)(
      implicit endpoint: RedisEndpoint
  ): Map[String, String] = doRedis(_.hgetAll(key).asScala.toMap)
  ...
  def smembers(key: String)(implicit endpoint: RedisEndpoint): Set[String] =
  ...
  def hincrByFloat(
      ...
      ttl: JInt = null,
      func: () => Unit = null
  )(implicit endpoint: RedisEndpoint): Double =
    doRedis(x => {
  ...
  def expire(key: String, s: Int)(implicit endpoint: RedisEndpoint) =
    doRedis(_.expire(key, s))

  def delByPattern(key: String, func: () => Unit = null)(
      implicit endpoint: RedisEndpoint
  ) =
    doRedis(
      r => {
  ...
  def hlen(key: String)(implicit endpoint: RedisEndpoint): Long =
    doRedis(_.hlen(key))

  def doRedis[R](f: Jedis => R, func: () => Unit = null)(
      implicit endpoint: RedisEndpoint
  ): R = {
  ...
  def doCluster[R](
      f: JedisCluster => R
  )(implicit endpoint: RedisEndpoint*): R = {
