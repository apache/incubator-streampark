...
object ExceptionUtils {
  ...
  /**
    ...
    */
  def isJvmFatalError(t: Throwable): Boolean =
    t.isInstanceOf[InternalError] || t.isInstanceOf[UnknownError] || t
      .isInstanceOf[ThreadDeath]
  ...
  /**
    ...
    */
  def isJvmFatalOrOutOfMemoryError(t: Throwable): Boolean =
    isJvmFatalError(t) || t.isInstanceOf[OutOfMemoryError]
  ...
  @Nullable def tryEnrichOutOfMemoryError(
      ...
      jvmDirectOomNewErrorMessage: String
  ): Throwable = {
  ...
  /**
    ...
    */
  private def changeOutOfMemoryErrorMessage(
  ...
  /**
    ...
    */
  def isMetaspaceOutOfMemoryError(@Nullable t: Throwable): Boolean =
    isOutOfMemoryErrorWithMessageStartingWith(t, "Metaspace")
  ...
  /**
    ...
    */
  def isDirectOutOfMemoryError(@Nullable t: Throwable): Boolean =
    isOutOfMemoryErrorWithMessageStartingWith(t, "Direct buffer memory")

  private def isOutOfMemoryErrorWithMessageStartingWith(
    ...
    isOutOfMemoryError(t) && t.getMessage != null && t.getMessage.startsWith(
      prefix
    )
  }

  private def isOutOfMemoryError(@Nullable t: Throwable) =
    t != null && (t.getClass eq classOf[OutOfMemoryError])
  ...
  def rethrowIfFatalErrorOrOOM(t: Throwable): Unit = {
    if (isJvmFatalError(t) || t.isInstanceOf[OutOfMemoryError])
      throw t.asInstanceOf[Error]
  }
  ...
  /**
    ...
    */
  def firstOrSuppressed[T <: Throwable](
      newException: T,
      @Nullable previous: T
  ): T = {
  ...
  def rethrow(t: Throwable): Unit = {
    ...
    else if (t.isInstanceOf[RuntimeException])
      throw t.asInstanceOf[RuntimeException]
  ...
  /**
    ...
    */
  def stripExecutionException(throwable: Throwable): Throwable =
    stripException(throwable, classOf[ExecutionException])
  ...
  /**
    ...
    */
  def stripCompletionException(throwable: Throwable): Throwable =
    stripException(throwable, classOf[CompletionException])
  ...
  /**
    ...
    */
  def stripException(
      throwableToStrip: Throwable,
      typeToStrip: Class[_ <: Throwable]
  ): Throwable = {
    var throwable: Throwable = null
    while (typeToStrip.isAssignableFrom(throwableToStrip.getClass()) && throwableToStrip
             .getCause() != null) {
