...
object ConfigConst {
  ...
  def printLogo(info: String): Unit = {
    ...
    println(ansi.eraseScreen.fg(YELLOW).a("           _____/ /_________  ____ _____ ___ ").fg(RED).a(" _  __"))
    println(ansi.eraseScreen.fg(YELLOW).a("          / ___/ __/ ___/ _ \\/ __ `/ __ `__ \\").fg(RED).a("| |/_/"))
    println(ansi.eraseScreen.fg(YELLOW).a("         (__  ) /_/ /  /  __/ /_/ / / / / / /").fg(RED).a(">  <  "))
    println(ansi.eraseScreen.fg(YELLOW).a("        /____/\\__/_/   \\___/\\__,_/_/ /_/ /_/").fg(RED).a("_/|_|  "))
    println(ansi.eraseScreen.fg(YELLOW).a("                                            ").fg(RED).a("  |/   "))
    println(ansi.eraseScreen.fg(YELLOW).a("                                            ").fg(RED).a("  .    "))
